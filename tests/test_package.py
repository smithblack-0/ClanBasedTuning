...
def test_package_imports() -> None:
    ...
    assert hasattr(clan_based_tuning, "ClanController")
    assert not hasattr(clan_based_tuning, "ClanPopulationPolicy")
    assert not hasattr(clan_based_tuning, "MemberResult")
    assert not hasattr(clan_based_tuning, "PopulationDecision")
